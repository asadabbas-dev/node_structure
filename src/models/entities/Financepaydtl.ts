...
@Entity("FINANCEPAYDTL", { schema: "dbo" })
export class Financepaydtl {
  ...
  @Column("varchar", { name: "NARATION", nullable: true, length: 150 })
  ...
  @Column("varchar", { name: "BANKCODE", nullable: true, length: 10 })
