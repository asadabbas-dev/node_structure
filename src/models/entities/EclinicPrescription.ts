...
@Index("PK_EclinicPrescription", ["prescriptionToken"], { unique: true })
@Entity("EclinicPrescription", { schema: "dbo" })
export class EclinicPrescription {
  @Column("varchar", { primary: true, name: "prescription_token", length: 100 })
  prescriptionToken: string;

  @Column("varchar", { name: "prescription_slip_token", length: 100 })
  prescriptionSlipToken: string;
  ...
  @Column("varchar", { name: "remark", nullable: true, length: 150 })
  remark: string | null;
  ...
  @Column("varchar", { name: "stop", nullable: true, length: 50 })
  stop: string | null;
