...
@Index("PK_FINANCEDTL", ["doctype", "subtype", "docnumber", "serialno"], {
  unique: true,
})
@Entity("FINANCEDTL", { schema: "dbo" })
export class Financedtl {
  ...
  @Column("int", { primary: true, name: "SERIALNO" })
  serialno: number;
  ...
  @Column("bit", { name: "ALLOCATIONFLG", default: () => "(0)" })
  ...
  @Column("bit", { name: "BANKRECONCIL", default: () => "(0)" })
  bankreconcil: boolean;
